...
//             <p className="text-xl text-muted-foreground">
// 302 3rd Floor , Beerumguda Main Rd , Ramachandra Reddy Nagar , Hyderabad , Telangana - 502032             </p>
//           </div>
...
const About = () => {
  const values = [
    ...
    },
    {
      ...
      title: "Our Vision",
      description:
        "To be the leading provider of digital services, setting industry standards for quality and innovation.",
    },
    {
      icon: Users,
      title: "Our Team",
      description:
        "A passionate group of developers, designers, and strategists dedicated to your success.",
    },
    {
      icon: Award,
      title: "Our Values",
          ...
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              ...
              <span className="bg-gradient-primary bg-clip-text text-transparent">
                Startit Technologies
              </span>
            </h1>
            <p className="text-xl text-muted-foreground">
              We're a team of passionate professionals dedicated to helping
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Founded with a vision to democratize access to professional
                  digital services, Startit Technologies has been helping
                  businesses of all sizes achieve their online goals.
                </p>
                <p>
                  With over 5 years of experience and 150+ successful projects,
                  we've built a reputation for delivering high-quality,
            ...
            <div className="relative">
              <img
                ...
                className="aspect-video w-full object-cover rounded-2xl shadow-elegant transition-transform duration-300 hover:scale-[1.02]"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Visit Our Office</h2>
            <p className="text-xl text-muted-foreground">
              302, 3rd Floor, Beerumguda Main Rd, Ramachandra Reddy Nagar,
          ...
          <div className="max-w-4xl mx-auto">
            <img
              ...
              className="w-full h-[400px] object-cover rounded-2xl shadow-elegant transition-transform duration-300 hover:scale-[1.02]"
            />
          </div>
        </div>
      </section>
